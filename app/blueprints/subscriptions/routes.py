...
def subscription_detail(subscription_id):
    ...
    return jsonify({
        ...
        'delivery': {
            ...
            'latitude': float(subscription.latitude) if subscription.latitude is not None else None,
            'longitude': float(subscription.longitude) if subscription.longitude is not None else None,
            'google_place_id': subscription.google_place_id or '',
            'formatted_address': subscription.formatted_address or '',
            'delivery_type': subscription.type,
            'size': subscription.size,
