...
def _subscription_snapshot(sub) -> dict:
    return {
        ...
        'status': sub.status,
        'size': sub.size,
        'custom_amount': sub.custom_amount,
        ...
        'city': sub.city,
        'street': sub.street,
        'building_number': sub.building_number,
        'floor': sub.floor,
        'entrance': sub.entrance,
        'is_pickup': sub.is_pickup,
        ...
        'recipient_social': sub.recipient_social,
        'for_whom': sub.for_whom,
        'bouquet_type': sub.bouquet_type,
        'composition_type': sub.composition_type,
        'comment': sub.comment,
